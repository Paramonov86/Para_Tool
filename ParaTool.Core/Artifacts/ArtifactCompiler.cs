...
public static class ArtifactCompiler
{
        ...
        Parsing.StatsResolver? resolver = null)
    {
        ...
        {
            var defaultBoosts = BoostMapping.SanitizeBoosts(art.DefaultBoosts);
        ...
        if (!string.IsNullOrEmpty(art.Boosts))
        {
            ...
            var filteredBoosts = BoostMapping.SanitizeBoosts(string.Join(";", kept));
        ...
        var mainHandBoosts = BoostMapping.SanitizeBoosts(art.BoostsOnEquipMainHand ?? "");
        var offHandBoosts = BoostMapping.SanitizeBoosts(art.BoostsOnEquipOffHand ?? "");
        ...
        {
            status.Boosts = BoostMapping.SanitizeBoosts(status.Boosts ?? "");
