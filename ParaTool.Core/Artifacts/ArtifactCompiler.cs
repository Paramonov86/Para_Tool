...
public static class ArtifactCompiler
{
        ...
        Parsing.StatsResolver? resolver = null)
    {
        ...
        {
            ValidatePlaceholders(art.StatId, "DefaultBoosts", art.DefaultBoosts, warnings);
            ValidateStatusReferences(art.StatId, "DefaultBoosts", art.DefaultBoosts, resolver, warnings);
        ...
        ValidatePlaceholders(art.StatId, "BoostsOnEquipMainHand", art.BoostsOnEquipMainHand ?? "", warnings);
        ValidateStatusReferences(art.StatId, "BoostsOnEquipMainHand", art.BoostsOnEquipMainHand ?? "", resolver, warnings);
        ValidatePlaceholders(art.StatId, "BoostsOnEquipOffHand", art.BoostsOnEquipOffHand ?? "", warnings);
        ValidateStatusReferences(art.StatId, "BoostsOnEquipOffHand", art.BoostsOnEquipOffHand ?? "", resolver, warnings);
