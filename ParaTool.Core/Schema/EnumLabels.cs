...
public static class EnumLabels
{
        ...
        new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["None"]                  = ("None",    "Нет"),
        ["All"]                   = ("All",     "Все"),
        // Damage types are written out in full — the chips have room for them and the
        // abbreviations ("Slash", "Некр.") read as if the value itself were truncated.
