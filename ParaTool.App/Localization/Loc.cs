...
public partial class Loc : ObservableObject
{
    ...
    public string LblSpellCards => this["LblSpellCards"];
    public string WmSearchSpell => this["WmSearchSpell"];
    public string WmSpellName => this["WmSpellName"];
    public string WmSpellDesc => this["WmSpellDesc"];
    public string LblSpellType => this["LblSpellType"];
    public string LblSpellLevel => this["LblSpellLevel"];
    public string LblSpellSchool => this["LblSpellSchool"];
    public string LblSpellCosts => this["LblSpellCosts"];
    public string LblSpellCooldown => this["LblSpellCooldown"];
    public string LblSpellRange => this["LblSpellRange"];
    public string LblSpellArea => this["LblSpellArea"];
    public string LblSpellRoll => this["LblSpellRoll"];
    public string LblSpellOnSuccess => this["LblSpellOnSuccess"];
    public string LblSpellOnFail => this["LblSpellOnFail"];
    public string LblSpellAlways => this["LblSpellAlways"];
    public string LblSpellTargets => this["LblSpellTargets"];
    public string LblSpellFlags => this["LblSpellFlags"];
    public string LblSpellDescParams => this["LblSpellDescParams"];
    ...
    public string LblContainer => this["LblContainer"];
    public string LblVariant => this["LblVariant"];
    public string LblVariants => this["LblVariants"];
    public string TipContainer => this["TipContainer"];
    ...
    public string WmReplaceCreature => this["WmReplaceCreature"];
    public string WmCreatureName => this["WmCreatureName"];
    public string TipCreatureCopy => this["TipCreatureCopy"];
    public string LblCreatureHp => this["LblCreatureHp"];
    public string LblCreatureAc => this["LblCreatureAc"];
    public string AbStr => this["AbStr"];
    public string AbDex => this["AbDex"];
    public string AbCon => this["AbCon"];
    public string AbInt => this["AbInt"];
    public string AbWis => this["AbWis"];
    public string AbCha => this["AbCha"];
